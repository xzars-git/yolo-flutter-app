    ...
    content: Container(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(width: 1.0, color: dangerColor),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Row(
              children: [
                const SizedBox(width: 10.0),
                Text(message, style: TextStyle(color: dangerColor)),
              ],
            ),
          ],
        ),
    ...
    content: Container(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(width: 1.0, color: successColor),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Row(
              children: [
                const SizedBox(width: 10.0),
                Text(message, style: TextStyle(color: successColor)),
              ],
            ),
          ],
        ),
    ...
    content: Container(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(width: 1.0, color: infoColor),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Row(
              children: [
                const SizedBox(width: 10.0),
                Text(message, style: TextStyle(color: infoColor)),
              ],
            ),
          ],
        ),
    ...
    content: Container(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(width: 1.0, color: warningColor),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Row(
              children: [
                const SizedBox(width: 10.0),
                Text(message, style: TextStyle(color: warningColor)),
              ],
            ),
          ],
        ),
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const SizedBox(width: 10.0),
                Icon(data, size: 24.0, color: primaryColor),
                const SizedBox(width: 10.0),
                Text(message, style: TextStyle(color: primaryColor)),
              ],
            ),
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const SizedBox(width: 10.0),
                Icon(data, size: 24.0, color: secondaryColor),
                const SizedBox(width: 10.0),
                Text(message, style: TextStyle(color: secondaryColor)),
              ],
            ),
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const SizedBox(width: 10.0),
                Icon(data, size: 24.0, color: successColor),
                const SizedBox(width: 10.0),
                Text(message, style: TextStyle(color: successColor)),
              ],
            ),
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const SizedBox(width: 10.0),
                Icon(data, size: 24.0, color: dangerColor),
                const SizedBox(width: 10.0),
                Text(message, style: TextStyle(color: dangerColor)),
              ],
            ),
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const SizedBox(width: 10.0),
                Icon(data, size: 24.0, color: infoColor),
                const SizedBox(width: 10.0),
                Text(message, style: TextStyle(color: infoColor)),
              ],
            ),
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const SizedBox(width: 10.0),
                Icon(data, size: 24.0, color: warningColor),
                const SizedBox(width: 10.0),
                Text(message, style: TextStyle(color: warningColor)),
              ],
            ),
...
snackbarIconPrimary({
  ...
  var snackBar = SnackBar(
    ...
    content: Row(
      children: [
        const SizedBox(width: 10.0),
        Icon(data, size: 24.0, color: Colors.white),
        const SizedBox(width: 10.0),
...
snackbarIconInfo({required String message, int duration = 4, IconData data = Icons.info_outline}) {
  var snackBar = SnackBar(
    padding: const EdgeInsets.all(10),
    duration: Duration(seconds: duration),
    backgroundColor: infoColor,
