...
ThemeData getDarkTheme() {
  return ThemeData.dark().copyWith(
    appBarTheme: AppBarTheme(
      elevation: 0.6,
      titleTextStyle: GoogleFonts.lato(color: Colors.white, fontWeight: FontWeight.bold),
    ...
    tabBarTheme: const TabBarThemeData(unselectedLabelColor: Colors.grey, labelColor: Colors.white),
