...
import 'package:ultralytics_yolo_example/theme/color_scheme_model.dart';

final TextTheme myTextTheme = TextTheme(
  displayLarge: GoogleFonts.roboto(fontSize: 26, fontWeight: FontWeight.w400, color: gray900),
  displayMedium: GoogleFonts.roboto(fontSize: 24, fontWeight: FontWeight.w700, color: gray900),
  displaySmall: GoogleFonts.roboto(fontSize: 22, fontWeight: FontWeight.w400, color: gray900),
  headlineLarge: GoogleFonts.roboto(fontSize: 20, fontWeight: FontWeight.w600, color: gray900),
  headlineMedium: GoogleFonts.roboto(fontSize: 18, fontWeight: FontWeight.w600, color: gray900),
  headlineSmall: GoogleFonts.roboto(fontSize: 16, fontWeight: FontWeight.w600, color: gray900),
  titleLarge: GoogleFonts.roboto(fontSize: 18, fontWeight: FontWeight.w700, color: gray900),
  titleMedium: GoogleFonts.roboto(fontSize: 16, fontWeight: FontWeight.w600, color: gray900),
  titleSmall: GoogleFonts.roboto(fontSize: 14, fontWeight: FontWeight.w700, color: gray900),
...
ColorSchemeModel myColorScheme = const ColorSchemeModel(
  brightness: Brightness.light,
  background: Color(0xFFEFF2F3),
  ...
  primaryContainer: Color(0xFFE6F6EC),
  onPrimaryContainer: Color(0xFF069550),
  secondaryContainer: Color(0xFFE3F2FD),
  onSecondaryContainer: Color(0xFF1565C0),
  tertiaryContainer: Color(0xFFFFF9E1),
