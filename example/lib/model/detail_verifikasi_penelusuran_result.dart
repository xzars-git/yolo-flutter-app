class DetailVerifikasiPenelusuranResult {
  int? code;
  DataDetailVerifikasiPenelusuran? data;
  String? message;
  String? status;

  DetailVerifikasiPenelusuranResult({this.code, this.data, this.message, this.status});

  DetailVerifikasiPenelusuranResult.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    data = json['data'] != null ? DataDetailVerifikasiPenelusuran.fromJson(json['data']) : null;
...
class DataDetailVerifikasiPenelusuran {
  String? id;
  String? kdStatus;
  String? nmStatus;
  String? idTelusur;
  ...
  DataDetailVerifikasiPenelusuran(
      {this.id,
      this.kdStatus,
      this.nmStatus,
      this.idTelusur,
  ...
  DataDetailVerifikasiPenelusuran.fromJson(Map<String, dynamic> json) {
    id = json['id'];
